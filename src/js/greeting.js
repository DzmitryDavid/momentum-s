const morningImg = ['background-image: linear-gradient(to right, #ed6ea0 0%, #ec8c69 100%);',
...
const dayImg = ['background-image: linear-gradient(to top, #50cc7f 0%, #f5d100 100%);',
...
const eveningImg = ['background-image: linear-gradient(to top, #88d3ce 0%, #6e45e2 100%);',
...
const nightImg = ['background-image: linear-gradient(to top, #09203f 0%, #537895 100%);',
...
const setBg = (src) => document.body.style = src;
